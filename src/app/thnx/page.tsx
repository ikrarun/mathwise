    ...
    return (
        <Suspense>
            <main style={font.style} className=" w-full relative min-h-full flex-grow flex-col flex px-6 pt-16 py-3 items-center justify-center gap-6 max-w-[900px] ">
                ...
                <h1 className='flex flex-col'>Meanwhile you can connect with me using the <br />
                    <a className='underline text-center self-center text-blue-800' href="https://instagram.com/thescribewise" target='_blank'><IoLogoInstagram /></a></h1>
